...
const values = [
  ...
  { icon: Users, title: "Comunidad", text: "Más de 25 años formando generaciones de profesionales exitosos, con una comunidad activa de padres, docentes y estudiantes comprometidos." },
];
