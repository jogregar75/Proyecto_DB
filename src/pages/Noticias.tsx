              ...
              {paginatedItems.map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      to={`/noticias/${item.id}`}
                      className="flex flex-col h-full text-left bg-card rounded-2xl border border-border shadow-sm overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all group"
                    >
                      ...
                      <div className="p-4 flex flex-col flex-1">
                        ...
                        <div className="flex items-center gap-1 text-[11px] text-muted-foreground mb-2 h-4">
                        ...
                        <h3 className="font-display font-bold text-foreground leading-tight  line-clamp-2 min-h-[3.5rem]">
                          {item.title}
                        </h3>
                        {/* <p className="text-sm text-muted-foreground mt-2 line-clamp-3"> */}
                        <p className="text-sm text-muted-foreground mt-2 line-clamp-3 min-h-[4.5rem] flex-1">
