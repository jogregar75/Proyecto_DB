...
import logo from "@/assets/logoCDB2.png";

const HimnoSimbolos = () => (
  <div className="pt-24 md:pt-28 pb-20">
    <div className="container mx-auto px-4 max-w-4xl">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
        <span className="text-accent font-semibold uppercase tracking-widest text-lg">Nuestra Identidad</span>
        <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mt-3">Himno y Símbolos Institucionales</h1>
      </motion.div>
      ...
      {/* <section className="my-12 text-center">
        ...
        <img src={logo} alt="Logo del Colegio Los Pirineos Don Bosco" className="w-32 mx-auto rounded-xl shadow" />
      </section> */}

      <section className="bg-card border border-border rounded-xl p-8 my-8 shadow-sm">
        <h2 className="font-display text-2xl font-bold text-foreground mb-6 text-center">Logo</h2>
        <img src={logo} alt="Logo del Colegio Los Pirineos Don Bosco" className="w-32 mx-auto rounded-xl shadow" />
        <h2 className="font-display text-2xl font-bold text-foreground mb-4 mt-6 text-center">Interpretación del Logo</h2>
