      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <div className="p-6 md:p-10">
            ...
            <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground text-center">{item.title}</h1>
            <p className="text-foreground/90 mt-6 whitespace-pre-line leading-relaxed text-base md:text-lg text-justify">
              {item.content}
            </p>
